...
from infrastructure.persistence.postgres_job_repository import SessionLocal, engine
from infrastructure.security import AuthService


def init_database():
    """Cria todas as tabelas no banco de dados."""
    print("[INFO] Criando schema do banco de dados...")
    try:
...
def create_initial_api_key():
    ...
    try:
        ...
        print("\n[IMPORTANTE] Guarde esta key em local seguro!")
        print("\n[TESTE] Teste com:")
        ...
        print(f"[ERRO] Erro ao criar API key: {e}")
        sys.exit(1)
    finally:
        db.close()
...
def main():
    ...
    print("\n" + "=" * 70)
    print("[OK] Inicializacao concluida! Proximos passos:")
    print("=" * 70)
    ...
    print("3. Acesse a documentacao: http://localhost:8000/docs")
    print("=" * 70)
